<template>
    <Head :title="`Edit Attribute: ${attribute.frontend_label}`" />

    <AdminLayout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                Edit Attribute: {{ attribute.frontend_label }}
            </h2>
        </template>
        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="flex justify-between mb-6">
                    ...
                    <div>
                        <Link 
                            v-if="attribute.frontend_input === 'select' || attribute.frontend_input === 'multiselect'"
                        ...
                        >
                            <i class="fas fa-list mr-1"></i> Manage Options
                        </Link>
                    </div>
                </div>
...
const form = useForm({
    ...
    frontend_input: props.attribute.frontend_input,
    frontend_label: props.attribute.frontend_label,
    is_required: props.attribute.is_required,
    is_unique: props.attribute.is_unique,
    is_filterable: props.attribute.is_filterable,
    is_searchable: props.attribute.is_searchable,
    is_comparable: props.attribute.is_comparable,
    is_visible_on_front: props.attribute.is_visible_on_front,
    sort_order: props.attribute.sort_order,
    default_value: props.attribute.default_value || '',
    frontend_class: props.attribute.frontend_class || '',
    note: props.attribute.note || '',
});
