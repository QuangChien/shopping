    ...
    <div class="flex h-screen bg-gray-100">
        ...
        <div :class="[
            ...
            <nav class="mt-8">
                ...
                <SidebarLink :href="route('admin.categories.index')" :label="translations.nav.categories" icon="category" />
                <SidebarLink :href="route('admin.products.index')" :label="translations.nav.products" icon="product" />
...
import SidebarLink from '@/Pages/Admin/Components/SidebarLink.vue';
...
// Method to add alert programmatically
const addAlert = (type, message, options = {}) => {
    if (alertContainer.value) {
        alertContainer.value.addAlert(type, message, options);
    }
};

// Expose the addAlert method to child components
defineExpose({
    addAlert
});
</script> 